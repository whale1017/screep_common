...
var ROLE_CONFIG = {
    ...
    // BACKUP_REPAIR: new RoleConfig(4000, [{type:WORK, count:1}, {type:CARRY, count:1},{type:MOVE, count:1}], 1050, {max:1, min:1}, "BACKUP_REPAIR"),
    ...
    MID_REPAIR: new RoleConfig(40, [{type:WORK, count:2}, {type:CARRY, count:4},{type:MOVE, count:3}], 450, {max:2, min:0}, "MID_REPAIR"),
    MID_MOVER: new RoleConfig(50, [{type:WORK, count:0}, {type:CARRY, count:7},{type:MOVE, count:4}], 470, {max:2, min:3}, "MID_MOVER"),
