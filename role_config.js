...
var ROLE_CONFIG = {
    ...
    // backup
    // BACKUP_HARVESTER: new RoleConfig(1000, [{type:WORK, count:1}, {type:CARRY, count:0},{type:MOVE, count:1}], 1090, {max:0, min:1}, "BACKUP_HARVESTER"), 
    BACKUP_UPGRADER: new RoleConfig(2000, [{type:WORK, count:1}, {type:CARRY, count:1},{type:MOVE, count:1}], 1060, {max:0, min:1}, "BACKUP_UPGRADER"), 
    // BACKUP_COLLECTOR: new RoleConfig(3000, [{type:WORK, count:0}, {type:CARRY, count:1},{type:MOVE, count:1}], 1080, {max:0, min:1}, "BACKUP_COLLECTOR"),
    // BACKUP_REPAIR: new RoleConfig(4000, [{type:WORK, count:1}, {type:CARRY, count:1},{type:MOVE, count:1}], 1050, {max:0, min:0}, "BACKUP_REPAIR"),
    // BACKUP_MOVER: new RoleConfig(5000, [{type:WORK, count:0}, {type:CARRY, count:1},{type:MOVE, count:1}], 1070, {max: 0, min:0}, "BACKUP_MOVER"),

    // 300
    MINI_HARVESTER: new RoleConfig(1, [{type:WORK, count:2}, {type:CARRY, count:0},{type:MOVE, count:2}], 390, {max:4, min:1}, "MINI_HARVESTER"), 
    MINI_UPGRADER: new RoleConfig(2, [{type:WORK, count:1}, {type:CARRY, count:2},{type:MOVE, count:2}], 360, {max:0, min:0}, "MINI_UPGRADER"), 
    MINI_COLLECTOR: new RoleConfig(3, [{type:WORK, count:0}, {type:CARRY, count:3},{type:MOVE, count:3}], 380, {max:2, min:1}, "MINI_COLLECTOR"),
    MINI_REPAIR: new RoleConfig(4, [{type:WORK, count:1}, {type:CARRY, count:2},{type:MOVE, count:2}], 350, {max:3, min:0}, "MINI_REPAIR"),
    MINI_MOVER: new RoleConfig(5, [{type:WORK, count:0}, {type:CARRY, count:3},{type:MOVE, count:3}], 370, {max: 1, min:0}, "MINI_MOVER"),

    // 550
    // MID_HARVESTER: new RoleConfig(10, [{type:WORK, count:4}, {type:CARRY, count:0},{type:MOVE, count:3}], 490, {max:3, min:1}, "MID_HARVESTER"), 
    // MID_UPGRADER: new RoleConfig(20, [{type:WORK, count:2}, {type:CARRY, count:4},{type:MOVE, count:3}], 460, {max:2, min:0}, "MID_UPGRADER"), 
    // MID_COLLECTOR: new RoleConfig(30, [{type:WORK, count:0}, {type:CARRY, count:7},{type:MOVE, count:4}], 480, {max:2, min:2}, "MID_COLLECTOR"),
    // MID_REPAIR: new RoleConfig(40, [{type:WORK, count:2}, {type:CARRY, count:4},{type:MOVE, count:3}], 450, {max:5, min:0}, "MID_REPAIR"),
